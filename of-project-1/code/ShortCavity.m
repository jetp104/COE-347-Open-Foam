...
files = {'top_UShortRe10.xy', 'second-row_UShortRe10.xy'; 
         'top_UShortRe100.xy', 'second-row_UShortRe100.xy';
         'top_UShortRe250.xy', 'second-row_UShortRe250.xy';
         'top_UShortRe400.xy', 'second-row_UShortRe400.xy'};
...
disp('First 10 values of U_top:'), disp(U_top(1:10)')
disp('First 10 values of U_second:'), disp(U_second(1:10)')

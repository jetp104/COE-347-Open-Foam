...
% Load the data
data_pi_over_4 = readmatrix('piover4_U.txt'); 
...
computeVelocityAndStrain(data_pi_over_4, pi/4, R, 'Velocity and Strain at \theta = \pi/4 (Fine)');
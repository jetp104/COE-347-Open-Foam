...
% Load the data for all three resolutions
data_coarse = readmatrix('piover4_UC.txt');  % Coarse mesh
data_fine = readmatrix('piover4_U.txt');    % Fine mesh
data_medium = readmatrix('piover4_UM.txt'); % Medium mesh
...
title('Velocity Profiles at \theta = \pi/4 for Different Mesh Resolutions');
grid on;
hold off;

% Save the figure
saveas(gcf, 'velocity_comparison_piover4.eps', 'epsc');